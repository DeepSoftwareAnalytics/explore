...
def main():
    ...
    # Required parameters
    # parser.add_argument("--data_dir", default="../src/data/train.adv_data.pkl", type=str, required=True,
    ...
    data = pickle.load(open(f"../src/data/{args.data_split}.adv_data.pkl", 'rb'))
    ...
    with open(f'../src/data/{args.data_split}_{args.code_type}.txt', 'w') as f:
        for item in lines:
            f.write("%s\n" % item)
